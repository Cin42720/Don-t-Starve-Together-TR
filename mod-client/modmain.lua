-- Don't Starve Together - Turkce Ceviri (Client)
-- modmain.lua
...
-- UI ve skin cevirilerini hemen yukle (ana menu, giris ekrani)
...
local function ApplyAllTranslations()
    ...
    modimport("scripts/compat_levels.lua")
    GLOBAL.package.loaded["map/customize"] = nil
    print("[Turkce Ceviri - Client] Tum ceviriler uygulandi!")
end
...
print("[Turkce Ceviri - Client] 82.000+ metin Turkceye cevrildi!")
